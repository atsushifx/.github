...
- Private report via GitHub Security Advisories
  [Create a security advisory](https://github.com/atsushifx/.github/security/advisories/new)
...
*This security policy applies to all repositories under the `@atsushifx` organizations.*
